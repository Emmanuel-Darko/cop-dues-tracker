...
const styles = {
  ...
  "components/AppToast.vue": () => import('./AppToast-styles.C5VBdM9U.mjs').then(interopDefault),
  "components/AppToast.vue?vue&type=style&index=0&scoped=1ba422b6&lang.css": () => import('./AppToast-styles.C5VBdM9U.mjs').then(interopDefault)
};
