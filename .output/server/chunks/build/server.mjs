import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, toRef, isRef, getCurrentInstance, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, createElementBlock, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { l as hasProtocol, m as isScriptProtocol, i as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch, o as createHooks, e as createError$1, p as defu, q as executeAsync, r as getHeader, t as setCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BukQrfEr.mjs')
  },
  {
    name: "collect",
    path: "/collect",
    component: () => import('./collect-CDhX53cW.mjs')
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import('./reports-Dh0_2Pj6.mjs')
  },
  {
    name: "officers",
    path: "/officers",
    component: () => import('./officers-h6mMfbPa.mjs')
  },
  {
    name: "payments",
    path: "/payments",
    component: () => import('./payments-BWC2hED3.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BBp4TDkH.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DDTpTQZo.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B-O1wxlz.mjs'));
...
export { _export_sfc as _, useRoute as a, useRouter as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, useState as e, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
